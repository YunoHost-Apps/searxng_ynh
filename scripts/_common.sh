...
# COMMON VARIABLES
#=================================================
pkg_dependencies="python3-dev python3-babel python3-venv uwsgi uwsgi-plugin-python3 git build-essential libxslt-dev zlib1g-dev libffi-dev libssl-dev uwsgi uwsgi-plugin-python3"
